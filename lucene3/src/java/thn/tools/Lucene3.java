...
{
    private static Logger log = Logger.getLogger(Lucene3.class);
    ...
    public Lucene3()
    {
        this.indexVersion = Version.LUCENE_36;
    }
    ...
    public void search(final String queryString, final int resultsPerPage, final int numberOfPages, final boolean displayResults)
    {
    ...
    {
        final Lucene3 lucene = new Lucene3();
        lucene.run(args);
    }
